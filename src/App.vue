...
<div class="container mx-auto sm:w-4/4 no-scroll">
  <!-- <img alt="Vue logo" class="logo" src="@/assets/logo.svg" width="125" height="125" /> -->
  
  <div class="mx-auto sm:w-4/4 flex ml-5 mt-3">
    <!-- drawer init and show -->
    <div class="flex mx-auto">
    <div class="text-center mr-3">
      <button
        :class="{ 'dark': isDarkMode }"
        class="text-white bg-blue-700 hover:bg-blue-800 dark:bg-neon-green dark:text-black focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
    ...
    <div class="text-center"  :class="{ 'dark': isDarkMode }">
      <button
        :class="{ 'dark': isDarkMode }"
        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 dark:bg-red-700 dark:hover:bg-red-600 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
    ...
    <div :class="{ 'dark': isDarkMode }" class="ml-3 mt-3 p-auto">

    <label class="theme-switch">
      <input type="checkbox" class="theme-switch__checkbox" v-model="isDarkMode" @click="toggleDarkMode">
      <div class="theme-switch__container" style="margin-top: -0.5rem;">
    ...
    <div id="drawer-swipe"
      ...
      <div
      class="p-4 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700" data-drawer-toggle="drawer-swipe">
      ...
      <div class="grid grid-cols-3 gap-4 p-4 lg:grid-cols-4">
        ...
        <div class="p-4 rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 dark:hover:bg-gray-600 dark:bg-gray-700">
          ...
          <div class="font-medium text-center text-gray-500 dark:text-gray-400">Development Team</div>
        </div>
        <div
          class="hidden p-4 rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 dark:hover:bg-gray-600 dark:bg-gray-700 lg:block">
          <div
          ...
          <div class="font-medium text-center text-gray-500 dark:text-gray-400">Design Team</div>
        </div>
        <div class="p-4 rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 dark:hover:bg-gray-600 dark:bg-gray-700">
        <div
          class="flex justify-center items-center p-2 mx-auto mb-2 bg-gray-200 dark:bg-gray-600 rounded-full w-[48px] h-[48px] max-w-[48px] max-h-[48px]">
  ...
  <div class="flex items-center justify-center min-h-screen">
    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <div class="p-5">
          <a href="#">
              <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">The calm before the project storm... Ready to create your first task?</h5>
          </a>
